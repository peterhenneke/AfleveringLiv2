...
\]
The initial value is $Y(m) = X(m)/\tilde{V}_0(m)$, where $X(m)$ is obtained from the single-path simulation in Exercise~(ii). A selection of 15 sample paths is shown below.
